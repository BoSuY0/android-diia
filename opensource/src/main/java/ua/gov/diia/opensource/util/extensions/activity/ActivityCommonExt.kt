...
private class EdgeToEdgeApi26 : EdgeToEdgeImpl {
    ...
    override fun setUp(window: Window, view: View, theme: Resources.Theme) {
        ...
        window.statusBarColor = view.context.getColorCompat(android.R.color.black, theme)
        window.navigationBarColor = view.context.getColorCompat(android.R.color.black, theme)
